...
This kind of question requires an understanding of *global sensitivty* of a
...
Thus $f$ is a determinstic program with probabilistic inputs, and we want to
...
positive and negative change can cancel out. Thus if one wanta measure of
...
and similary for the second, third, etc. indices.
...
$\epsilon < d/2$, one of those intervals is completely encapsolated in $I$,
